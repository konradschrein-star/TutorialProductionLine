...
readonly rehearsal="tutorial_studio_c24_rehearsal"
...
readonly backup_dir="/var/backups/tutorial-omar-pre-candidate24-${stamp}"
...
rehearsal_created=1
runuser -u postgres -- pg_restore --exit-on-error -d "$rehearsal" "$backup"

// Upgrade only the reviewed private VPS2 web canary to Candidate 29.
import fs from "node:fs";
import { spawnSync } from "node:child_process";
const root = "/opt/tutorial-recovery-staging";
const image = "tutorial-recovery:20260910-candidate29";
const expectedImageId = "sha256:a63f96a2c550d32e3a6d4da2d7e4082c34207e87a790c4127c7d4231fabae534";
const previousImage = "tutorial-recovery:20260910-candidate28";
...
const overridePath = `${root}/candidate29.web-media.override.json`;
...
else throw new Error("Candidate29 override absent");

...
const image = "tutorial-recovery:20260910-candidate24";
const expectedImageId = "sha256:86394246f0c97cfa3cc32e627053114529650481382d56c4b376ca29b001bf5c";
...
const overridePath = root + "/candidate24.web-media.override.json";
...
if (fs.existsSync(overridePath)) {
  ...
  throw Error("Candidate 24 override is absent; run --prepare-config explicitly before checking or upgrading");
}

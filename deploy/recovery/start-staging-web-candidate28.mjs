// Upgrade only the reviewed private VPS2 web canary to Candidate 28.
import fs from "node:fs";
import { spawnSync } from "node:child_process";
const root = "/opt/tutorial-recovery-staging";
const image = "tutorial-recovery:20260910-candidate28";
const expectedImageId = "sha256:f9c772fb27f1fd219cba7b051fa06797509f8dae289210c591a7a8482d7923ec";
const previousImage = "tutorial-recovery:20260910-candidate27";
...
const overridePath = `${root}/candidate28.web-media.override.json`;
...
else throw new Error("Candidate28 override absent");

...
const PAGES = [
  ...
  { label: "Create Job", href: "/jobs/create", icon: "add" },
  { label: "Production Board", href: "/factory", icon: "factory" },
  ...
  { label: "Clip Forge", href: "/clip-forge", icon: "auto_awesome_motion" },
  { label: "Formats", href: "/formats", icon: "category" },
  ...
  { label: "Style Library", href: "/style-library", icon: "palette" },
  { label: "Clip Library", href: "/clip-library", icon: "local_movies" },
  { label: "Music Library", href: "/settings/music", icon: "library_music" },
  { label: "Knowledge", href: "/knowledge", icon: "school" },

...
export function V2Button({
  ...
  const baseClasses =
    "inline-flex items-center justify-center gap-2 font-semibold uppercase tracking-wide transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  const sizeClasses = {
    ...
    md: "px-4 py-2 text-[11px] rounded-lg",
    lg: "px-6 py-3 text-[12px] rounded-lg",
  };
